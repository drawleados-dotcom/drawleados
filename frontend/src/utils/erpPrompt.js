...
export const buildErpPrompt = ({ projectName, userName, pageName, subTabName, ultraSubTabName, ultraTabName, taskName }) => {
  const parts = [projectName, userName, pageName, subTabName, ultraSubTabName, ultraTabName].filter(Boolean);
