...
/**
 * Campaign-level "Reports" tab (kept for SEO projects; Meta Ads projects use the
 * day-wise ProjectMetaReportsTab) — daily campaign performance submitted from the
 ...
 */
export default function ProjectCampaignReportsTab({ project, isDark, bgCard, bgSecondary, textPrimary, textSecondary, borderColor }) {
