...
from bni_weekly_routes import bni_weekly_router, bni_give_ask_router
...
from meta_import_routes import meta_import_router
...
async def get_me(user: User = Depends(get_current_user)):
    ...
    has_operations_module = any(str(m).lower() == "operations" for m in user_modules)
    designation_config = None
    if desg_title:
        # Try exact match first, then case-insensitive fallback for resilience
        ...
        if desg_doc:
            designation_config = {
                ...
                "operations_payment_schedule": desg_doc.get("operations_payment_schedule", "visible") or "visible",
...
api_router.include_router(bni_weekly_router)
api_router.include_router(bni_give_ask_router)
api_router.include_router(bni_one_to_one_router)
...
api_router.include_router(bni_outreach_sources_router)
...
api_router.include_router(meta_import_router)
