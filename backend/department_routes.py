...
async def add_website_page(project_id: str, request: Request):
    ...
    task = {
        ...
        # Wireframe column
        "wireframe_status": "To-Do",
        "wireframe_assignee": data.get("wireframe_assignee"),
        "wireframe_due": data.get("wireframe_due"),
        "wireframe_url": data.get("wireframe_url"),
        # UI Design column
        "ui_status": "To-Do",
        "ui_assignee": data.get("ui_assignee"),
        "ui_due": data.get("ui_due"),
        "ui_url": data.get("ui_url"),
        # Content column
        "content_status": "To-Do",
        "content_assignee": data.get("content_assignee"),
        "content_due": data.get("content_due"),
        "content_url": data.get("content_url"),
        # Development column
        "dev_status": "To-Do",
        "dev_assignee": data.get("dev_assignee"),
        "dev_due": data.get("dev_due"),
        "dev_url": data.get("dev_url"),
        # Overall
        "overall_status": "To-Do",
        "overall_url": data.get("overall_url"),
